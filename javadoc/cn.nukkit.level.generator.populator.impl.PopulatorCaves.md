...
<td class="colLast"><code><span class="memberNameLink"><a >caveFrequency</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >caveMaxAltitude</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >caveMinAltitude</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >caveRarity</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >caveSystemFrequency</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >caveSystemPocketChance</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >caveSystemPocketMaxSize</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >caveSystemPocketMinSize</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>protected int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >checkAreaSize</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >evenCaveDistribution</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >individualCaveRarity</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >worldHeightCap</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PopulatorCaves</a></span>()</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >generateCaveNode</a></span>(long seed,
...
<td class="colLast"><code><span class="memberNameLink"><a >generateChunk</a></span>(int chunkX,
             int chunkZ,
             <a  title="interface in cn.nukkit.level.format">FullChunk</a> generatingChunkBuffer)</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code>protected void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >generateLargeCaveNode</a></span>(long seed,
                     <a  title="interface in cn.nukkit.level.format">FullChunk</a> chunk,
                     double x,
                     double y,
                     double z)</code> </td>
...
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >numberInRange</a></span>(<a  title="class or interface in java.util">Random</a> random,
             int min,
             int max)</code> </td>
</tr>
<tr id="i4" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >populate</a></span>(<a  title="interface in cn.nukkit.level">ChunkManager</a> level,
        int chunkX,
        int chunkZ,
        <a  title="class in cn.nukkit.math">NukkitRandom</a> random,
        <a  title="interface in cn.nukkit.level.format">FullChunk</a> chunk)</code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.generator.populator.type.Populator">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.generator.populator.type.<a  title="class in cn.nukkit.level.generator.populator.type">Populator</a></h3>
<code><a >getHighestWorkableBlock</a></code></li>
</ul>
<ul class="blockList">
