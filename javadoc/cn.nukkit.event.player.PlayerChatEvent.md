...
<tr class="rowColor">
<td class="colFirst"><code>protected <a  title="class or interface in java.util">Set</a>&lt;<a  title="interface in cn.nukkit.command">CommandSender</a>&gt;</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >recipients</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.cn.nukkit.event.player.PlayerMessageEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.player.<a  title="class in cn.nukkit.event.player">PlayerMessageEvent</a></h3>
<code><a >message</a></code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerChatEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
               <a  title="class or interface in java.lang">String</a> message)</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerChatEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
               <a  title="class or interface in java.lang">String</a> message,
               <a  title="class or interface in java.lang">String</a> format,
               <a  title="class or interface in java.util">Set</a>&lt;<a  title="interface in cn.nukkit.command">CommandSender</a>&gt; recipients)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getFormat</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code><a  title="class or interface in java.util">Set</a>&lt;<a  title="interface in cn.nukkit.command">CommandSender</a>&gt;</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getRecipients</a></span>()</code> </td>
</tr>
<tr id="i3" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setFormat</a></span>(<a  title="class or interface in java.lang">String</a> format)</code> </td>
</tr>
<tr id="i4" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setPlayer</a></span>(<a  title="class in cn.nukkit">Player</a> player)</code>
<div class="block">Changes the player that is sending the message</div>
</td>
</tr>
<tr id="i5" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setRecipients</a></span>(<a  title="class or interface in java.util">Set</a>&lt;<a  title="interface in cn.nukkit.command">CommandSender</a>&gt; recipients)</code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.player.PlayerMessageEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.player.<a  title="class in cn.nukkit.event.player">PlayerMessageEvent</a></h3>
<code><a >getMessage</a>, <a >setMessage</a></code></li>
</ul>
<ul class="blockList">
