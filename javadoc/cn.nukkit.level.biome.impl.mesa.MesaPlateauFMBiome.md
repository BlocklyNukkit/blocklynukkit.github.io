...
<h3>成员变量一览</h3>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.cn.nukkit.level.biome.impl.mesa.MesaBiome">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.biome.impl.mesa.<a  title="class in cn.nukkit.level.biome.impl.mesa">MesaBiome</a></h3>
<code><a >moundHeight</a></code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >MesaPlateauFMBiome</a></span>()</code> </td>
</tr>
</table>
</li>
</ul>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.biome.impl.mesa.MesaPlateauFBiome">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.biome.impl.mesa.<a  title="class in cn.nukkit.level.biome.impl.mesa">MesaPlateauFBiome</a></h3>
<code><a >getCoverId</a></code></li>
</ul>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.biome.impl.mesa.MesaBiome">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.biome.impl.mesa.<a  title="class in cn.nukkit.level.biome.impl.mesa">MesaBiome</a></h3>
<code><a >canRain</a>, <a >getGroundDepth</a>, <a >getGroundId</a>, <a >getHeightOffset</a>, <a >getMoundFrequency</a>, <a >getSurfaceDepth</a>, <a >getSurfaceId</a>, <a >minHill</a>, <a >setMoundHeight</a></code></li>
</ul>
<ul class="blockList">
