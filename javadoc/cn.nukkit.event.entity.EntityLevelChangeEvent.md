...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >EntityLevelChangeEvent</a></span>(<a  title="class in cn.nukkit.entity">Entity</a> entity,
                      <a  title="class in cn.nukkit.level">Level</a> originLevel,
                      <a  title="class in cn.nukkit.level">Level</a> targetLevel)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getOrigin</a></span>()</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.level">Level</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getTarget</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
