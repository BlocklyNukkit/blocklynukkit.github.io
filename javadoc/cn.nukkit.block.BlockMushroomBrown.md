...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockMushroomBrown</a></span>()</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockMushroomBrown</a></span>(int meta)</code> </td>
</tr>
</table>
</li>
</ul>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.block.BlockMushroom">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.block.<a  title="class in cn.nukkit.block">BlockMushroom</a></h3>
<code><a >canBeActivated</a>, <a >canSilkTouch</a>, <a >canStay</a>, <a >getColor</a>, <a >grow</a>, <a >onActivate</a>, <a >onUpdate</a>, <a >place</a></code></li>
</ul>
<ul class="blockList">
