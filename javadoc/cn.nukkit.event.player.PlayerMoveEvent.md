...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerMoveEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
               <a  title="class in cn.nukkit.level">Location</a> from,
               <a  title="class in cn.nukkit.level">Location</a> to)</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerMoveEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
               <a  title="class in cn.nukkit.level">Location</a> from,
               <a  title="class in cn.nukkit.level">Location</a> to,
               boolean resetBlocks)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getFrom</a></span>()</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >isResetBlocksAround</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setFrom</a></span>(<a  title="class in cn.nukkit.level">Location</a> from)</code> </td>
</tr>
<tr id="i6" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setResetBlocksAround</a></span>(boolean value)</code> </td>
</tr>
<tr id="i7" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setTo</a></span>(<a  title="class in cn.nukkit.level">Location</a> to)</code> </td>
</tr>
</table>
<ul class="blockList">
