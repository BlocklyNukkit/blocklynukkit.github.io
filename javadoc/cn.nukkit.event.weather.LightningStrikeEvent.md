...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >LightningStrikeEvent</a></span>(<a  title="class in cn.nukkit.level">Level</a> level,
                    <a  title="interface in cn.nukkit.entity.weather">EntityLightningStrike</a> bolt)</code> </td>
</tr>
</table>
</li>
</ul>
...
<div class="block">Gets the bolt which is striking the earth.</div>
</td>
</tr>
</table>
<ul class="blockList">
