...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerMapInfoRequestEvent</a></span>(<a  title="class in cn.nukkit">Player</a> p,
...
<td class="colLast"><code><span class="memberNameLink"><a >getMap</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
