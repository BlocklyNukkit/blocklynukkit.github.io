...
<td class="colLast"><code><span class="memberNameLink"><a >brewTime</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >fuelAmount</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >fuelTotal</a></span></code> </td>
</tr>
<tr class="rowColor">
...
<td class="colLast"><code><span class="memberNameLink"><a >ingredients</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>protected <a  title="class in cn.nukkit.inventory">BrewingInventory</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >inventory</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >MAX_BREW_TIME</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockEntityBrewingStand</a></span>(<a  title="interface in cn.nukkit.level.format">FullChunk</a> chunk,
...
<td class="colLast"><code><span class="memberNameLink"><a >checkIngredient</a></span>(<a  title="class in cn.nukkit.item">Item</a> ingredient)</code> </td>
</tr>
...
<td class="colFirst"><code><a  title="class in cn.nukkit.inventory">BrewingInventory</a></code></td>
...
<td class="colFirst"><code>protected void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >sendBrewTime</a></span>()</code> </td>
</tr>
<tr id="i16" class="altColor">
<td class="colFirst"><code>protected void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >sendFuel</a></span>()</code> </td>
</tr>
<tr id="i17" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setFuel</a></span>(int fuel)</code> </td>
</tr>
...
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >updateBlock</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
