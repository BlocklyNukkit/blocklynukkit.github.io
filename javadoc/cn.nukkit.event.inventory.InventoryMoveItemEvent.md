...
<td class="colLast"><code><span class="memberNameLink"><a  title="enum in cn.nukkit.event.inventory">InventoryMoveItemEvent.Action</a></span></code> </td>
</tr>
</table>
</li>
</ul>  
...
<h3>成员变量一览</h3>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.cn.nukkit.event.inventory.InventoryEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.inventory.<a  title="class in cn.nukkit.event.inventory">InventoryEvent</a></h3>
<code><a >inventory</a></code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >InventoryMoveItemEvent</a></span>(<a  title="interface in cn.nukkit.inventory">Inventory</a> from,
                      <a  title="interface in cn.nukkit.inventory">Inventory</a> targetInventory,
                      <a  title="interface in cn.nukkit.inventory">InventoryHolder</a> source,
                      <a  title="class in cn.nukkit.item">Item</a> item,
                      <a  title="enum in cn.nukkit.event.inventory">InventoryMoveItemEvent.Action</a> action)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colFirst"><code><a  title="enum in cn.nukkit.event.inventory">InventoryMoveItemEvent.Action</a></code></td>
...
<td class="colLast"><code><span class="memberNameLink"><a >getTargetInventory</a></span>()</code> </td>
</tr>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.inventory.InventoryEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.inventory.<a  title="class in cn.nukkit.event.inventory">InventoryEvent</a></h3>
<code><a >getInventory</a>, <a >getViewers</a></code></li>
</ul>
<ul class="blockList">
