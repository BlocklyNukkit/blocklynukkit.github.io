...
<tr class="altColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.level.generator.noise.vanilla.f">NoiseGeneratorOctavesF</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >depthNoise</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.level.generator.noise.vanilla.f">NoiseGeneratorOctavesF</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >scaleNoise</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >seaHeight</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.cn.nukkit.level.generator.Generator">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.generator.<a  title="class in cn.nukkit.level.generator">Generator</a></h3>
<code><a >TYPE_FLAT</a>, <a >TYPE_INFINITE</a>, <a >TYPE_NETHER</a>, <a >TYPE_OLD</a></code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >Normal</a></span>()</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >Normal</a></span>(<a  title="class or interface in java.util">Map</a>&lt;<a  title="class or interface in java.lang">String</a>,<a  title="class or interface in java.lang">Object</a>&gt; options)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colFirst"><code><a  title="interface in cn.nukkit.level">ChunkManager</a></code></td>
...
<td class="colLast"><code><span class="memberNameLink"><a >pickBiome</a></span>(int x,
         int z)</code> </td>
</tr>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.generator.Generator">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.generator.<a  title="class in cn.nukkit.level.generator">Generator</a></h3>
<code><a >addGenerator</a>, <a >getDimension</a>, <a >getGenerator</a>, <a >getGenerator</a>, <a >getGeneratorList</a>, <a >getGeneratorName</a>, <a >getGeneratorType</a></code></li>
</ul>
<ul class="blockList">
