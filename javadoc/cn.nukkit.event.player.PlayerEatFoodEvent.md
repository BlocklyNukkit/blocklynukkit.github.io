...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerEatFoodEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
                  <a  title="class in cn.nukkit.item.food">Food</a> food)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getFood</a></span>()</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >setFood</a></span>(<a  title="class in cn.nukkit.item.food">Food</a> food)</code> </td>
</tr>
</table>
<ul class="blockList">
