...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >SimpleCommand</a></span>(<a  title="class or interface in java.lang">Object</a> object,
             <a  title="class or interface in java.lang.reflect">Method</a> method,
...
<td class="colLast"><code><span class="memberNameLink"><a >sendInGameMessage</a></span>(<a  title="interface in cn.nukkit.command">CommandSender</a> sender)</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >sendUsageMessage</a></span>(<a  title="interface in cn.nukkit.command">CommandSender</a> sender)</code> </td>
</tr>
<tr id="i3" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setForbidConsole</a></span>(boolean forbidConsole)</code> </td>
</tr>
<tr id="i4" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setMaxArgs</a></span>(int maxArgs)</code> </td>
</tr>
<tr id="i5" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setMinArgs</a></span>(int minArgs)</code> </td>
</tr>
</table>
<ul class="blockList">
