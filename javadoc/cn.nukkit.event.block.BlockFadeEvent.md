...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockFadeEvent</a></span>(<a  title="class in cn.nukkit.block">Block</a> block,
...
<td class="colLast"><code><span class="memberNameLink"><a >getNewState</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
