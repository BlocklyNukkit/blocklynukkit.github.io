...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerBucketEmptyEvent</a></span>(<a  title="class in cn.nukkit">Player</a> who,
                      <a  title="class in cn.nukkit.block">Block</a> blockClicked,
                      <a  title="enum in cn.nukkit.math">BlockFace</a> blockFace,
                      <a  title="class in cn.nukkit.item">Item</a> bucket,
                      <a  title="class in cn.nukkit.item">Item</a> itemInHand)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getBlockClicked</a></span>()</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >getBucket</a></span>()</code>
<div class="block">Returns the bucket used in this event</div>
</td>
</tr>
...
<td class="colFirst"><code><a  title="class in cn.nukkit.item">Item</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getItem</a></span>()</code>
<div class="block">Returns the item in hand after the event</div>
</td>
</tr>
