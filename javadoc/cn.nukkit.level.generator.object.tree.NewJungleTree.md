...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >NewJungleTree</a></span>(int minTreeHeight,
             int maxTreeHeight)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >generate</a></span>(<a  title="interface in cn.nukkit.level">ChunkManager</a> worldIn,
        <a  title="class in cn.nukkit.math">NukkitRandom</a> rand,
        <a  title="class in cn.nukkit.math">Vector3</a> vectorPosition)</code> </td>
</tr>
</table>
<ul class="blockList">
