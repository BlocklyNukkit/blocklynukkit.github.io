...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerItemHeldEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
                   <a  title="class in cn.nukkit.item">Item</a> item,
                   int hotbarSlot)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getInventorySlot</a></span>()</code>
