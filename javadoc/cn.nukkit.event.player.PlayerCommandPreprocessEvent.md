...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerCommandPreprocessEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
...
<td class="colLast"><code><span class="memberNameLink"><a >setPlayer</a></span>(<a  title="class in cn.nukkit">Player</a> player)</code> </td>
</tr>
</table>
<ul class="blockList">
