...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerServerSettingsRequestEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
                                <a  title="class or interface in java.util">Map</a>&lt;<a  title="class or interface in java.lang">Integer</a>,<a  title="class in cn.nukkit.form.window">FormWindow</a>&gt; settings)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colFirst"><code><a  title="class or interface in java.util">Map</a>&lt;<a  title="class or interface in java.lang">Integer</a>,<a  title="class in cn.nukkit.form.window">FormWindow</a>&gt;</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getSettings</a></span>()</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setSettings</a></span>(int id,
           <a  title="class in cn.nukkit.form.window">FormWindow</a> window)</code> </td>
</tr>
<tr id="i3" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setSettings</a></span>(<a  title="class or interface in java.util">Map</a>&lt;<a  title="class or interface in java.lang">Integer</a>,<a  title="class in cn.nukkit.form.window">FormWindow</a>&gt; settings)</code> </td>
</tr>
</table>
<ul class="blockList">
