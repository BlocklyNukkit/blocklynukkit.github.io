...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockRailActivator</a></span>()</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockRailActivator</a></span>(int meta)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >canPowered</a></span>(<a  title="class in cn.nukkit.math">Vector3</a> pos,
          <a  title="enum in cn.nukkit.utils">Rail.Orientation</a> state,
          int power,
          boolean relative)</code> </td>
</tr>
<tr id="i1" class="rowColor">
<td class="colFirst"><code>protected boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >checkSurrounding</a></span>(<a  title="class in cn.nukkit.math">Vector3</a> pos,
                boolean relative,
                int power)</code>
<div class="block">Check the surrounding of the rail</div>
</td>
</tr>
