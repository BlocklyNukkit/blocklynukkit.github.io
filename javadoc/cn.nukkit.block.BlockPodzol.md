...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockPodzol</a></span>()</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockPodzol</a></span>(int meta)</code> </td>
</tr>
</table>
</li>
</ul>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.block.BlockDirt">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.block.<a  title="class in cn.nukkit.block">BlockDirt</a></h3>
<code><a >getDrops</a>, <a >getHardness</a>, <a >getResistance</a>, <a >getToolType</a></code></li>
</ul>
<ul class="blockList">
