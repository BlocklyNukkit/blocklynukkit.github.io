...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >EntityLlama</a></span>(<a  title="interface in cn.nukkit.level.format">FullChunk</a> chunk,
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.entity.passive.EntityAnimal">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.entity.passive.<a  title="class in cn.nukkit.entity.passive">EntityAnimal</a></h3>
<code><a >isBaby</a>, <a >isBreedingItem</a>, <a >onInteract</a></code></li>
</ul>
<ul class="blockList">
