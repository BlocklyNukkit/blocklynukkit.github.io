...
<td class="colLast"><code><span class="memberNameLink"><a >moundHeight</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.cn.nukkit.level.biome.Biome">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.biome.<a  title="class in cn.nukkit.level.biome">Biome</a></h3>
<code><a >biomes</a>, <a >MAX_BIOMES</a>, <a >unorderedBiomes</a></code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >MesaBiome</a></span>()</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getGroundDepth</a></span>(int x,
              int y,
              int z)</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code>int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getGroundId</a></span>(int x,
           int y,
           int z)</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >getMoundFrequency</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code>int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getSurfaceDepth</a></span>(int x,
               int y,
               int z)</code> </td>
</tr>
<tr id="i7" class="rowColor">
<td class="colFirst"><code>int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getSurfaceId</a></span>(int x,
            int y,
            int z)</code> </td>
</tr>
<tr id="i8" class="altColor">
<td class="colFirst"><code>protected float</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >minHill</a></span>()</code> </td>
</tr>
<tr id="i9" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setMoundHeight</a></span>(int height)</code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.biome.type.CoveredBiome">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.biome.type.<a  title="class in cn.nukkit.level.biome.type">CoveredBiome</a></h3>
<code><a >doCover</a>, <a >getCoverId</a></code></li>
</ul>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.biome.Biome">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.biome.<a  title="class in cn.nukkit.level.biome">Biome</a></h3>
<code><a >addPopulator</a>, <a >clearPopulators</a>, <a >doesOverhang</a>, <a >equals</a>, <a >getBaseHeight</a>, <a >getBiome</a>, <a >getBiome</a>, <a >getHeightVariation</a>, <a >getId</a>, <a >getPopulators</a>, <a >hashCode</a>, <a >isFreezing</a>, <a >populateChunk</a>, <a >register</a>, <a >setBaseHeight</a>, <a >setHeightVariation</a>, <a >setId</a></code></li>
</ul>
<ul class="blockList">
