...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >VehicleDamageEvent</a></span>(<a  title="class in cn.nukkit.entity">Entity</a> vehicle,
                  <a  title="class in cn.nukkit.entity">Entity</a> attacker,
                  double damage)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getAttacker</a></span>()</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >setDamage</a></span>(double damage)</code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.vehicle.VehicleEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.vehicle.<a  title="class in cn.nukkit.event.vehicle">VehicleEvent</a></h3>
<code><a >getVehicle</a></code></li>
</ul>
<ul class="blockList">
