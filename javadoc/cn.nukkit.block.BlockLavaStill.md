...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockLavaStill</a></span>()</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockLavaStill</a></span>(int meta)</code> </td>
</tr>
</table>
</li>
</ul>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.block.BlockLava">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.block.<a  title="class in cn.nukkit.block">BlockLava</a></h3>
<code><a >addVelocityToEntity</a>, <a >checkForHarden</a>, <a >flowIntoBlock</a>, <a >getColor</a>, <a >getFlowDecayPerBlock</a>, <a >getLightLevel</a>, <a >isSurroundingBlockFlammable</a>, <a >onEntityCollide</a>, <a >place</a>, <a >tickRate</a></code></li>
</ul>
<ul class="blockList">
