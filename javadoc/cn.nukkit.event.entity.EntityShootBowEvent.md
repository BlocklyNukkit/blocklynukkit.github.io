...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >EntityShootBowEvent</a></span>(<a  title="class in cn.nukkit.entity">EntityLiving</a> shooter,
                   <a  title="class in cn.nukkit.item">Item</a> bow,
                   <a  title="class in cn.nukkit.entity.projectile">EntityProjectile</a> projectile,
                   double force)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getBow</a></span>()</code> </td>
</tr>
<tr id="i1" class="rowColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.entity">EntityLiving</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getEntity</a></span>()</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code>double</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getForce</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code><a  title="class in cn.nukkit.entity.projectile">EntityProjectile</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getProjectile</a></span>()</code> </td>
</tr>
<tr id="i5" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setForce</a></span>(double force)</code> </td>
</tr>
<tr id="i6" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setProjectile</a></span>(<a  title="class in cn.nukkit.entity">Entity</a> projectile)</code> </td>
</tr>
</table>
<ul class="blockList">
