...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >EnchantItemEvent</a></span>(<a  title="class in cn.nukkit.inventory">EnchantInventory</a> inventory,
                <a  title="class in cn.nukkit.item">Item</a> oldItem,
                <a  title="class in cn.nukkit.item">Item</a> newItem,
                int cost,
                <a  title="class in cn.nukkit">Player</a> p)</code> </td>
</tr>
</table>
</li>
</ul>
