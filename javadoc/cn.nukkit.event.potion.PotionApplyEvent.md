...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PotionApplyEvent</a></span>(<a  title="class in cn.nukkit.potion">Potion</a> potion,
                <a  title="class in cn.nukkit.potion">Effect</a> applyEffect,
...
<td class="colLast"><code><span class="memberNameLink"><a >getApplyEffect</a></span>()</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >setApplyEffect</a></span>(<a  title="class in cn.nukkit.potion">Effect</a> applyEffect)</code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.potion.PotionEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.potion.<a  title="class in cn.nukkit.event.potion">PotionEvent</a></h3>
<code><a >getPotion</a>, <a >setPotion</a></code></li>
</ul>
<ul class="blockList">
