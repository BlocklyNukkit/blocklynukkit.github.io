...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >DesertHillsBiome</a></span>()</code> </td>
</tr>
</table>
</li>
</ul>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.biome.impl.desert.DesertBiome">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.biome.impl.desert.<a  title="class in cn.nukkit.level.biome.impl.desert">DesertBiome</a></h3>
<code><a >canRain</a></code></li>
</ul>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.biome.type.SandyBiome">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.biome.type.<a  title="class in cn.nukkit.level.biome.type">SandyBiome</a></h3>
