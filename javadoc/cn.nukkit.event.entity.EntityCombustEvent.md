...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >EntityCombustEvent</a></span>(<a  title="class in cn.nukkit.entity">Entity</a> combustee,
...
<td class="colLast"><code><span class="memberNameLink"><a >setDuration</a></span>(int duration)</code> </td>
</tr>
</table>
<ul class="blockList">
