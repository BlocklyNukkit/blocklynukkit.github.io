...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockSpreadEvent</a></span>(<a  title="class in cn.nukkit.block">Block</a> block,
                <a  title="class in cn.nukkit.block">Block</a> source,
                <a  title="class in cn.nukkit.block">Block</a> newState)</code> </td>
</tr>
</table>
</li>
</ul>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.block.BlockGrowEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.block.<a  title="class in cn.nukkit.event.block">BlockGrowEvent</a></h3>
<code><a >getNewState</a></code></li>
</ul>
<ul class="blockList">
