...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >CraftItemEvent</a></span>(<a  title="class in cn.nukkit.inventory.transaction">CraftingTransaction</a> transaction)</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >CraftItemEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
              <a  title="class in cn.nukkit.item">Item</a>[] input,
              <a  title="interface in cn.nukkit.inventory">Recipe</a> recipe)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getInput</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code><a  title="interface in cn.nukkit.inventory">Recipe</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getRecipe</a></span>()</code> </td>
</tr>
<tr id="i4" class="altColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.inventory.transaction">CraftingTransaction</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getTransaction</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
