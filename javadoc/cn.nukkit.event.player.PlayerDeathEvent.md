...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerDeathEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
                <a  title="class in cn.nukkit.item">Item</a>[] drops,
                <a  title="class or interface in java.lang">String</a> deathMessage,
                int experience)</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerDeathEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
                <a  title="class in cn.nukkit.item">Item</a>[] drops,
                <a  title="class in cn.nukkit.lang">TextContainer</a> deathMessage,
                int experience)</code> </td>
</tr>
</table>
</li>
...
<td class="colLast"><code><span class="memberNameLink"><a >getDeathMessage</a></span>()</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >getKeepExperience</a></span>()</code> </td>
</tr>
<tr id="i5" class="rowColor">
<td class="colFirst"><code>boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getKeepInventory</a></span>()</code> </td>
</tr>
<tr id="i6" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setDeathMessage</a></span>(<a  title="class or interface in java.lang">String</a> deathMessage)</code> </td>
</tr>
<tr id="i7" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setDeathMessage</a></span>(<a  title="class in cn.nukkit.lang">TextContainer</a> deathMessage)</code> </td>
</tr>
<tr id="i8" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setExperience</a></span>(int experience)</code> </td>
</tr>
<tr id="i9" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setKeepExperience</a></span>(boolean keepExperience)</code> </td>
</tr>
<tr id="i10" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setKeepInventory</a></span>(boolean keepInventory)</code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.entity.EntityDeathEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.entity.<a  title="class in cn.nukkit.event.entity">EntityDeathEvent</a></h3>
<code><a >getDrops</a>, <a >setDrops</a></code></li>
</ul>
<ul class="blockList">
