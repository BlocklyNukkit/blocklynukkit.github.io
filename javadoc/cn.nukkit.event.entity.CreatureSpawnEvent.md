...
<td class="colLast"><code><span class="memberNameLink"><a  title="enum in cn.nukkit.event.entity">CreatureSpawnEvent.SpawnReason</a></span></code>
<div class="block">An enum to specify the type of spawning</div>
</td>
</tr>
</table>
</li>
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >CreatureSpawnEvent</a></span>(int networkId,
                  <a  title="class in cn.nukkit.level">Position</a> position,
                  <a  title="class in cn.nukkit.nbt.tag">CompoundTag</a> nbt,
                  <a  title="enum in cn.nukkit.event.entity">CreatureSpawnEvent.SpawnReason</a> reason)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getEntityNetworkId</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code><a  title="enum in cn.nukkit.event.entity">CreatureSpawnEvent.SpawnReason</a></code></td>
