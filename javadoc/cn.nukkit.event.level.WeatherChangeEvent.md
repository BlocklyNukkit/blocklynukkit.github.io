...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >WeatherChangeEvent</a></span>(<a  title="class in cn.nukkit.level">Level</a> level,
                  boolean to)</code> </td>
</tr>
</table>
</li>
...
<td class="colLast"><code><span class="memberNameLink"><a >toWeatherState</a></span>()</code>
<div class="block">Gets the state of weather that the world is being set to</div>
</td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.level.WeatherEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.level.<a  title="class in cn.nukkit.event.level">WeatherEvent</a></h3>
