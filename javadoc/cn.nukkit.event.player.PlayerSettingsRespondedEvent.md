...
<td class="colLast"><code><span class="memberNameLink"><a >formID</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>protected <a  title="class in cn.nukkit.form.window">FormWindow</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >window</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerSettingsRespondedEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
                            int formID,
                            <a  title="class in cn.nukkit.form.window">FormWindow</a> window)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getFormID</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code><a  title="class in cn.nukkit.form.response">FormResponse</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getResponse</a></span>()</code>
<div class="block">Can be null if player closed the window instead of submitting it</div>
</td>
</tr>
<tr id="i3" class="rowColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.form.window">FormWindow</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getWindow</a></span>()</code> </td>
</tr>
<tr id="i4" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setCancelled</a></span>()</code> </td>
</tr>
<tr id="i5" class="rowColor">
<td class="colFirst"><code>boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >wasClosed</a></span>()</code>
<div class="block">Defines if player closed the window or submitted it</div>
</td>
</tr>
</table>
<ul class="blockList">
...
<h3>继承自类 cn.nukkit.event.<a  title="class in cn.nukkit.event">Event</a></h3>
<code><a >getEventName</a>, <a >isCancelled</a>, <a >setCancelled</a></code></li>
</ul>
<ul class="blockList">
...
<code><a >isCancelled</a>, <a >setCancelled</a></code></li>
</ul>
</li>
</ul>
</li>
