...
<td class="colLast"><code><span class="memberNameLink"><a >CAUSE_CUSTOM</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >CAUSE_EATING</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >CAUSE_MAGIC</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >CAUSE_REGEN</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >EntityRegainHealthEvent</a></span>(<a  title="class in cn.nukkit.entity">Entity</a> entity,
                       float amount,
                       int regainReason)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getAmount</a></span>()</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >getRegainReason</a></span>()</code> </td>
</tr>
<tr id="i3" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setAmount</a></span>(float amount)</code> </td>
</tr>
</table>
<ul class="blockList">
