...
<td class="colLast"><code><span class="memberNameLink"><a >combuster</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.cn.nukkit.event.entity.EntityCombustEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.entity.<a  title="class in cn.nukkit.event.entity">EntityCombustEvent</a></h3>
<code><a >duration</a></code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >EntityCombustByEntityEvent</a></span>(<a  title="class in cn.nukkit.entity">Entity</a> combuster,
                          <a  title="class in cn.nukkit.entity">Entity</a> combustee,
...
<td class="colLast"><code><span class="memberNameLink"><a >getCombuster</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.entity.EntityCombustEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.entity.<a  title="class in cn.nukkit.event.entity">EntityCombustEvent</a></h3>
<code><a >getDuration</a>, <a >getHandlers</a>, <a >setDuration</a></code></li>
</ul>
<ul class="blockList">
