...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >EntityDamageByChildEntityEvent</a></span>(<a  title="class in cn.nukkit.entity">Entity</a> damager,
                              <a  title="class in cn.nukkit.entity">Entity</a> childEntity,
...
<td class="colLast"><code><span class="memberNameLink"><a >getChild</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.entity.EntityDamageByEntityEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.entity.<a  title="class in cn.nukkit.event.entity">EntityDamageByEntityEvent</a></h3>
<code><a >addAttackerModifiers</a>, <a >getDamager</a>, <a >getKnockBack</a>, <a >setKnockBack</a></code></li>
</ul>
<ul class="blockList">
