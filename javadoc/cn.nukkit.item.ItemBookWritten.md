...
<td class="colLast"><code><span class="memberNameLink"><a >GENERATION_COPY</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >GENERATION_COPY_OF_COPY</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >GENERATION_ORIGINAL</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>static int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >GENERATION_TATTERED</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >ItemBookWritten</a></span>()</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >ItemBookWritten</a></span>(<a  title="class or interface in java.lang">Integer</a> meta)</code> </td>
</tr>
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >ItemBookWritten</a></span>(<a  title="class or interface in java.lang">Integer</a> meta,
               int count)</code> </td>
</tr>
</table>
</li>
...
<td class="colLast"><code><span class="memberNameLink"><a >getAuthor</a></span>()</code>
<div class="block">Returns the author of this book.</div>
</td>
</tr>
<tr id="i1" class="rowColor">
<td class="colFirst"><code>int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getGeneration</a></span>()</code>
<div class="block">Returns the generation of the book.</div>
</td>
</tr>
...
<td class="colFirst"><code><a  title="class or interface in java.lang">String</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getTitle</a></span>()</code>
<div class="block">Returns the title of this book.</div>
</td>
</tr>
<tr id="i4" class="altColor">
<td class="colFirst"><code><a  title="class or interface in java.lang">String</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getXUID</a></span>()</code>
<div class="block">Returns the author's XUID of this book.</div>
</td>
</tr>
<tr id="i5" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setAuthor</a></span>(<a  title="class or interface in java.lang">String</a> author)</code>
<div class="block">Sets the author of this book.</div>
</td>
</tr>
<tr id="i6" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setGeneration</a></span>(int generation)</code>
<div class="block">Sets the generation of a book.</div>
</td>
</tr>
<tr id="i7" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setTitle</a></span>(<a  title="class or interface in java.lang">String</a> title)</code>
<div class="block">Sets the title of this book.</div>
</td>
</tr>
<tr id="i8" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setXUID</a></span>(<a  title="class or interface in java.lang">String</a> title)</code>
<div class="block">Sets the author's XUID of this book.</div>
</td>
</tr>
<tr id="i9" class="rowColor">
<td class="colFirst"><code>boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >signBook</a></span>(<a  title="class or interface in java.lang">String</a> title,
        <a  title="class or interface in java.lang">String</a> author,
        <a  title="class or interface in java.lang">String</a> xuid,
        int generation)</code> </td>
</tr>
<tr id="i10" class="altColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.item">Item</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >writeBook</a></span>(<a  title="class or interface in java.lang">String</a> author,
         <a  title="class or interface in java.lang">String</a> title,
         <a  title="class in cn.nukkit.nbt.tag">ListTag</a>&lt;<a  title="class in cn.nukkit.nbt.tag">CompoundTag</a>&gt; pages)</code> </td>
</tr>
<tr id="i11" class="rowColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.item">Item</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >writeBook</a></span>(<a  title="class or interface in java.lang">String</a> author,
         <a  title="class or interface in java.lang">String</a> title,
         <a  title="class or interface in java.lang">String</a>[] pages)</code> </td>
</tr>
</table>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.item.ItemBookWritable">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.item.<a  title="class in cn.nukkit.item">ItemBookWritable</a></h3>
<code><a >addPage</a>, <a >createPageTag</a>, <a >createPageTag</a>, <a >deletePage</a>, <a >getPages</a>, <a >getPageText</a>, <a >insertPage</a>, <a >insertPage</a>, <a >pageExists</a>, <a >setPageText</a>, <a >swapPages</a></code></li>
</ul>
<ul class="blockList">
