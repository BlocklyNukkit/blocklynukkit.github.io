...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PopulatorFlower</a></span>()</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >addType</a></span>(int a,
       int b)</code> </td>
</tr>
<tr id="i1" class="rowColor">
<td class="colFirst"><code>protected boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >canStay</a></span>(int x,
       int y,
       int z,
...
<td class="colFirst"><code><a  title="class or interface in java.util">List</a>&lt;int[]&gt;</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getTypes</a></span>()</code> </td>
</tr>
<tr id="i4" class="altColor">
<td class="colFirst"><code>protected void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >placeBlock</a></span>(int x,
          int y,
          int z,
          int id,
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.generator.populator.type.PopulatorSurfaceBlock">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.generator.populator.type.<a  title="class in cn.nukkit.level.generator.populator.type">PopulatorSurfaceBlock</a></h3>
<code><a >getHighestWorkableBlock</a>, <a >populateCount</a></code></li>
</ul>
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.level.generator.populator.type.PopulatorCount">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.level.generator.populator.type.<a  title="class in cn.nukkit.level.generator.populator.type">PopulatorCount</a></h3>
<code><a >populate</a>, <a >setBaseAmount</a>, <a >setRandomAmount</a></code></li>
</ul>
<ul class="blockList">
