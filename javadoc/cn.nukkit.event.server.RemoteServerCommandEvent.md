...
<h3>成员变量一览</h3>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.cn.nukkit.event.server.ServerCommandEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.server.<a  title="class in cn.nukkit.event.server">ServerCommandEvent</a></h3>
<code><a >command</a>, <a >sender</a></code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >RemoteServerCommandEvent</a></span>(<a  title="interface in cn.nukkit.command">CommandSender</a> sender,
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.event.server.ServerCommandEvent">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.event.server.<a  title="class in cn.nukkit.event.server">ServerCommandEvent</a></h3>
<code><a >getCommand</a>, <a >getSender</a>, <a >setCommand</a></code></li>
</ul>
<ul class="blockList">
