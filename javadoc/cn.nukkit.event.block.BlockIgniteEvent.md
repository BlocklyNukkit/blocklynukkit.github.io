...
<td class="colLast"><code><span class="memberNameLink"><a  title="enum in cn.nukkit.event.block">BlockIgniteEvent.BlockIgniteCause</a></span></code> </td>
</tr>
</table>
</li>
</ul>
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockIgniteEvent</a></span>(<a  title="class in cn.nukkit.block">Block</a> block,
                <a  title="class in cn.nukkit.block">Block</a> source,
                <a  title="class in cn.nukkit.entity">Entity</a> entity,
                <a  title="enum in cn.nukkit.event.block">BlockIgniteEvent.BlockIgniteCause</a> cause)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colFirst"><code><a  title="enum in cn.nukkit.event.block">BlockIgniteEvent.BlockIgniteCause</a></code></td>
