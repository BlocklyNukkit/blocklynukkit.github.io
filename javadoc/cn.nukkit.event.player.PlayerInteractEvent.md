...
<td class="colLast"><code><span class="memberNameLink"><a  title="enum in cn.nukkit.event.player">PlayerInteractEvent.Action</a></span></code> </td>
</tr>
</table>
</li>
</ul>
...
<tr class="altColor">
<td class="colFirst"><code>protected <a  title="enum in cn.nukkit.event.player">PlayerInteractEvent.Action</a></code></td>
...
<td class="colLast"><code><span class="memberNameLink"><a >blockFace</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>protected <a  title="class in cn.nukkit.block">Block</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >blockTouched</a></span></code> </td>
</tr>
<tr class="rowColor">
...
<td class="colLast"><code><span class="memberNameLink"><a >touchVector</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerInteractEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
                   <a  title="class in cn.nukkit.item">Item</a> item,
                   <a  title="class in cn.nukkit.math">Vector3</a> block,
...
<td class="colOne"><code><span class="memberNameLink"><a >PlayerInteractEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
                   ...
                   <a  title="enum in cn.nukkit.event.player">PlayerInteractEvent.Action</a> action)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colFirst"><code><a  title="enum in cn.nukkit.event.player">PlayerInteractEvent.Action</a></code></td>
...
<td class="colLast"><code><span class="memberNameLink"><a >getTouchVector</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
