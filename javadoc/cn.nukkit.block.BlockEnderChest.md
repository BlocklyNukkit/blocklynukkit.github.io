...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockEnderChest</a></span>()</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockEnderChest</a></span>(int meta)</code> </td>
</tr>
</table>
</li>
</ul>
...
<h3>继承自类 cn.nukkit.block.<a  title="class in cn.nukkit.block">Block</a></h3>
<code><a >addVelocityToEntity</a>, <a >calculateIntercept</a>, <a >canBeBrokenWith</a>, <a >canBeClimbed</a>, <a >canBeFlowedInto</a>, <a >canBePlaced</a>, <a >canBeReplaced</a>, <a >canPassThrough</a>, <a >clone</a>, <a >collidesWithBB</a>, <a >collidesWithBB</a>, <a >down</a>, <a >down</a>, <a >east</a>, <a >east</a>, <a >equals</a>, <a >equals</a>, <a >get</a>, <a >get</a>, <a >get</a>, <a >get</a>, <a >get</a>, <a >getBoundingBox</a>, <a >getBreakTime</a>, <a >getBreakTime</a>, <a >getBurnAbility</a>, <a >getBurnChance</a>, <a >getCollisionBoundingBox</a>, <a >getComparatorInputOverride</a>, <a >getDropExp</a>, <a >getFrictionFactor</a>, <a >getLocationHash</a>, <a >getMetadata</a>, <a >getMinY</a>, <a >getSaveId</a>, <a >getSide</a>, <a >getSide</a>, <a >getStrongPower</a>, <a >getWeakPower</a>, <a >hasComparatorInputOverride</a>, <a >hasEntityCollision</a>, <a >hasMetadata</a>, <a >init</a>, <a >isBreakable</a>, <a >isNormalBlock</a>, <a >isPowerSource</a>, <a >isSolid</a>, <a >north</a>, <a >north</a>, <a >onActivate</a>, <a >onBreak</a>, <a >onEntityCollide</a>, <a >onUpdate</a>, <a >position</a>, <a >recalculateBoundingBox</a>, <a >recalculateCollisionBoundingBox</a>, <a >removeMetadata</a>, <a >setDamage</a>, <a >setMetadata</a>, <a >south</a>, <a >south</a>, <a >tickRate</a>, <a >toString</a>, <a >up</a>, <a >up</a>, <a >west</a>, <a >west</a></code></li>
</ul>
<ul class="blockList">
