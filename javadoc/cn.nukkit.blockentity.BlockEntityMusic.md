...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockEntityMusic</a></span>(<a  title="interface in cn.nukkit.level.format">FullChunk</a> chunk,
...
<td class="colLast"><code><span class="memberNameLink"><a >changePitch</a></span>()</code> </td>
</tr>
