...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >InventoryPickupItemEvent</a></span>(<a  title="interface in cn.nukkit.inventory">Inventory</a> inventory,
                        <a  title="class in cn.nukkit.entity.item">EntityItem</a> item)</code> </td>
</tr>
</table>
</li>
</ul>
