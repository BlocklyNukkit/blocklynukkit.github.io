...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >ThunderChangeEvent</a></span>(<a  title="class in cn.nukkit.level">Level</a> level,
                  boolean to)</code> </td>
</tr>
</table>
</li>
...
<td class="colLast"><code><span class="memberNameLink"><a >toThunderState</a></span>()</code>
<div class="block">Gets the state of thunder that the world is being set to</div>
</td>
</tr>
</table>
<ul class="blockList">
