...
<td class="colLast"><code><span class="memberNameLink"><a >burnDuration</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>protected int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >burnTime</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>protected int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >cookTime</a></span></code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>protected <a  title="class in cn.nukkit.inventory">FurnaceInventory</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >inventory</a></span></code> </td>
</tr>
<tr class="altColor">
<td class="colFirst"><code>protected int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >maxTime</a></span></code> </td>
</tr>
</table>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockEntityFurnace</a></span>(<a  title="interface in cn.nukkit.level.format">FullChunk</a> chunk,
...
<td class="colLast"><code><span class="memberNameLink"><a >checkFuel</a></span>(<a  title="class in cn.nukkit.item">Item</a> fuel)</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >getBurnDuration</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code>int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getCookTime</a></span>()</code> </td>
</tr>
<tr id="i5" class="rowColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.inventory">FurnaceInventory</a></code></td>
...
<td class="colFirst"><code>int</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getMaxTime</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setBurnDuration</a></span>(int burnDuration)</code> </td>
</tr>
<tr id="i19" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setBurnTime</a></span>(int burnTime)</code> </td>
</tr>
<tr id="i20" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setCookTime</a></span>(int cookTime)</code> </td>
</tr>
...
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setMaxTime</a></span>(int maxTime)</code> </td>
</tr>
...
<h3>继承自类 cn.nukkit.blockentity.<a  title="class in cn.nukkit.blockentity">BlockEntity</a></h3>
<code><a >createBlockEntity</a>, <a >getBlock</a>, <a >getCleanedNBT</a>, <a >getDefaultCompound</a>, <a >getId</a>, <a >getSaveId</a>, <a >isMovable</a>, <a >registerBlockEntity</a>, <a >scheduleUpdate</a>, <a >setDirty</a></code></li>
</ul>
<ul class="blockList">
