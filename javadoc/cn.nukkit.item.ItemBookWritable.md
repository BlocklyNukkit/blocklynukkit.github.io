...
<td class="colLast"><code><span class="memberNameLink"><a >ItemBookWritable</a></span>(int id)</code> </td>
</tr>
<tr class="rowColor">
<td class="colFirst"><code>protected </code></td>
<td class="colLast"><code><span class="memberNameLink"><a >ItemBookWritable</a></span>(int id,
...
<td class="colLast"><code><span class="memberNameLink"><a >addPage</a></span>(int pageId)</code>
<div class="block">Adds a new page with the given page ID.</div>
</td>
</tr>
<tr id="i1" class="rowColor">
<td class="colFirst"><code>protected static <a  title="class in cn.nukkit.nbt.tag">CompoundTag</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >createPageTag</a></span>()</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code>protected static <a  title="class in cn.nukkit.nbt.tag">CompoundTag</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >createPageTag</a></span>(<a  title="class or interface in java.lang">String</a> pageText)</code> </td>
</tr>
<tr id="i3" class="rowColor">
<td class="colFirst"><code>boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >deletePage</a></span>(int pageId)</code>
<div class="block">Deletes an existing page with the given page ID.</div>
</td>
</tr>
<tr id="i4" class="altColor">
<td class="colFirst"><code><a  title="class or interface in java.util">List</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getPages</a></span>()</code>
<div class="block">Returns an list containing all pages of this book.</div>
</td>
</tr>
<tr id="i5" class="rowColor">
<td class="colFirst"><code><a  title="class or interface in java.lang">String</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getPageText</a></span>(int pageId)</code>
<div class="block">Returns a string containing the content of a page (which could be empty), or null if the page doesn't exist.</div>
</td>
</tr>
<tr id="i6" class="altColor">
<td class="colFirst"><code>boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >insertPage</a></span>(int pageId)</code>
<div class="block">Inserts a new page with the given text and moves other pages upwards.</div>
</td>
</tr>
<tr id="i7" class="rowColor">
<td class="colFirst"><code>boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >insertPage</a></span>(int pageId,
          <a  title="class or interface in java.lang">String</a> pageText)</code>
<div class="block">Inserts a new page with the given text and moves other pages upwards.</div>
</td>
</tr>
<tr id="i8" class="altColor">
<td class="colFirst"><code>boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >pageExists</a></span>(int pageId)</code>
<div class="block">Returns whether the given page exists in this book.</div>
</td>
</tr>
<tr id="i9" class="rowColor">
<td class="colFirst"><code>boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setPageText</a></span>(int pageId,
           <a  title="class or interface in java.lang">String</a> pageText)</code>
<div class="block">Sets the text of a page in the book.</div>
</td>
</tr>
<tr id="i10" class="altColor">
<td class="colFirst"><code>boolean</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >swapPages</a></span>(int pageId1,
         int pageId2)</code>
<div class="block">Switches the text of two pages with each other.</div>
</td>
</tr>
</table>
<ul class="blockList">
