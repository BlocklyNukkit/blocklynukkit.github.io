...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerAnimationEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player)</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >PlayerAnimationEvent</a></span>(<a  title="class in cn.nukkit">Player</a> player,
                    <a  title="enum in cn.nukkit.network.protocol">AnimatePacket.Action</a> animation)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getAnimationType</a></span>()</code> </td>
</tr>
