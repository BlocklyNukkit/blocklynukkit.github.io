...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >StructureGrowEvent</a></span>(<a  title="class in cn.nukkit.block">Block</a> block,
                  <a  title="class or interface in java.util">List</a>&lt;<a  title="class in cn.nukkit.block">Block</a>&gt; blocks)</code> </td>
</tr>
</table>
</li>
</ul>
