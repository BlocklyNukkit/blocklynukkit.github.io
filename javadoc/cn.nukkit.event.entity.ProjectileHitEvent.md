...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >ProjectileHitEvent</a></span>(<a  title="class in cn.nukkit.entity.projectile">EntityProjectile</a> entity)</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >ProjectileHitEvent</a></span>(<a  title="class in cn.nukkit.entity.projectile">EntityProjectile</a> entity,
                  <a  title="class in cn.nukkit.level">MovingObjectPosition</a> movingObjectPosition)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getMovingObjectPosition</a></span>()</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setMovingObjectPosition</a></span>(<a  title="class in cn.nukkit.level">MovingObjectPosition</a> movingObjectPosition)</code> </td>
</tr>
</table>
<ul class="blockList">
