...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >InventoryClickEvent</a></span>(<a  title="class in cn.nukkit">Player</a> who,
                   <a  title="interface in cn.nukkit.inventory">Inventory</a> inventory,
                   int slot,
                   <a  title="class in cn.nukkit.item">Item</a> sourceItem,
                   <a  title="class in cn.nukkit.item">Item</a> heldItem)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getHeldItem</a></span>()</code> </td>
</tr>
...
<td class="colFirst"><code><a  title="class in cn.nukkit.item">Item</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getSourceItem</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
