...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >EntityInventoryChangeEvent</a></span>(<a  title="class in cn.nukkit.entity">Entity</a> entity,
...
<td class="colLast"><code><span class="memberNameLink"><a >getNewItem</a></span>()</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code><a  title="class in cn.nukkit.item">Item</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getOldItem</a></span>()</code> </td>
</tr>
...
<td class="colLast"><code><span class="memberNameLink"><a >setNewItem</a></span>(<a  title="class in cn.nukkit.item">Item</a> newItem)</code> </td>
</tr>
</table>
<ul class="blockList">
