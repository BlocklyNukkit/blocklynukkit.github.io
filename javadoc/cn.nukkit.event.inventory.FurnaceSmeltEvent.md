...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >FurnaceSmeltEvent</a></span>(<a  title="class in cn.nukkit.blockentity">BlockEntityFurnace</a> furnace,
                 <a  title="class in cn.nukkit.item">Item</a> source,
                 <a  title="class in cn.nukkit.item">Item</a> result)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >setResult</a></span>(<a  title="class in cn.nukkit.item">Item</a> result)</code> </td>
</tr>
</table>
<ul class="blockList">
