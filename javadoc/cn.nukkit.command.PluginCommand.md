...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >PluginCommand</a></span>(<a  title="class or interface in java.lang">String</a> name,
             <a  title="type parameter in PluginCommand">T</a> owner)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colFirst"><code><a  title="interface in cn.nukkit.command">CommandExecutor</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getExecutor</a></span>()</code> </td>
</tr>
<tr id="i2" class="altColor">
<td class="colFirst"><code><a  title="type parameter in PluginCommand">T</a></code></td>
<td class="colLast"><code><span class="memberNameLink"><a >getPlugin</a></span>()</code> </td>
</tr>
<tr id="i3" class="rowColor">
<td class="colFirst"><code>void</code></td>
<td class="colLast"><code><span class="memberNameLink"><a >setExecutor</a></span>(<a  title="interface in cn.nukkit.command">CommandExecutor</a> executor)</code> </td>
</tr>
</table>
<ul class="blockList">
