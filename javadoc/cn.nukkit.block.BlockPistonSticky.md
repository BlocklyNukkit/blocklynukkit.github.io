...
<ul class="blockList">
<li class="blockList"><a name="nested.classes.inherited.from.class.cn.nukkit.block.BlockPistonBase">
<!--   -->
</a>
<h3>Nested classes/interfaces inherited from class cn.nukkit.block.<a  title="class in cn.nukkit.block">BlockPistonBase</a></h3>
<code><a  title="class in cn.nukkit.block">BlockPistonBase.BlocksCalculator</a></code></li>
</ul>
<ul class="blockList">
...
<h3>成员变量一览</h3>
<ul class="blockList">
<li class="blockList"><a name="fields.inherited.from.class.cn.nukkit.block.BlockPistonBase">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.block.<a  title="class in cn.nukkit.block">BlockPistonBase</a></h3>
<code><a >sticky</a></code></li>
</ul>
<ul class="blockList">
...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockPistonSticky</a></span>()</code> </td>
</tr>
<tr class="rowColor">
<td class="colOne"><code><span class="memberNameLink"><a >BlockPistonSticky</a></span>(int meta)</code> </td>
</tr>
</table>
</li>
</ul>
...
<ul class="blockList">
<li class="blockList"><a name="methods.inherited.from.class.cn.nukkit.block.BlockPistonBase">
<!--   -->
</a>
<h3>继承自类 cn.nukkit.block.<a  title="class in cn.nukkit.block">BlockPistonBase</a></h3>
<code><a >canPush</a>, <a >getBlockFace</a>, <a >getFacing</a>, <a >getHardness</a>, <a >getResistance</a>, <a >isExtended</a>, <a >onBreak</a>, <a >onUpdate</a>, <a >place</a>, <a >toItem</a></code></li>
</ul>
<ul class="blockList">
