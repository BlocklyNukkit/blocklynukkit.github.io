...
<tr class="altColor">
<td class="colOne"><code><span class="memberNameLink"><a >SpawnChangeEvent</a></span>(<a  title="class in cn.nukkit.level">Level</a> level,
                <a  title="class in cn.nukkit.level">Position</a> previousSpawn)</code> </td>
</tr>
</table>
</li>
</ul>
...
<td class="colLast"><code><span class="memberNameLink"><a >getPreviousSpawn</a></span>()</code> </td>
</tr>
</table>
<ul class="blockList">
